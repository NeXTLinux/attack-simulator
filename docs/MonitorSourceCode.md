...
9. This shows how [`Harden-Runner`](https://github.com/nextlinux/harden-runner) prevents malicious steps from calling `sudo` and detects file overwrites during build.
