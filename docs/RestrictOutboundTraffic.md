...
3. GitHub Action workflow files are in the `.github/workflows` folder of the repo. Browse to the [ci.yml](../.github/workflows/ci.yml) file. Edit it using the GitHub website, and add the `nextlinux/harden-runner` GitHub Action as the first step. Commit the changes to `main` branch.
